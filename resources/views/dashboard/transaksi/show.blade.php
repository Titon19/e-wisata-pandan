                                    ...
                                    <table class="table table-borderless mb-0">
                                        <tbody>
                                            <tr>
                                                <td>
                                                    {{-- <img
                                                        src="{{ $transaction->wisata->thumbnail == '' ? asset('img/default.png') : url(Storage::url($transaction->wisata->thumbnail)) }}"
                                                        alt="contact-img" title="contact-img" class="rounded mr-2"
                                                        height="48"> --}}
                                                    <p class="m-0 d-inline-block align-middle">
                                                        <a href="#!" class="text-body font-weight-bold">Nama</a>
                                                        <br>
                                                ...
                                                {{-- <td class="text-right">
                                                    Rp.
                                                    {{ number_format($transaction->people_count * $transaction->days *
                                                    $transaction->wisata->price, 0, ',', '.') }}
                                                </td> --}}
                                                <td class="text-right">
                                                    {{ $userName }}
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <p class="m-0 d-inline-block align-middle">
                                                        <a href="#!" class="text-body font-weight-bold">Kategori
                                                            Usia</a>
                                                        <br>
                                                </td>
                                                <td class="text-right">
                                            ...
                                            <tr>
                                                <td>
                                                    <p class="m-0 d-inline-block align-middle">
                                                        <a href="#!" class="text-body font-weight-bold">Kunjungan</a>
                                                        <br>
                                                </td>
                                                <td class="text-right">
                                                    {{ $transaction->visited }}
                                            ...
                                            <tr>
                                                <td>
                                                    <p class="m-0 d-inline-block align-middle">
                                                        <a href="#!" class="text-body font-weight-bold">Jml Orang &
                                                            Hari</a>
                                                        <br>
                                                </td>
                                                <td class="text-right">
                                            ...
                                            <tr>
                                                <td>
                                                    <p class="m-0 d-inline-block align-middle">
                                                        <a href="#!" class="text-body font-weight-bold">Jml Tiket</a>
                                                        <br>
                                                </td>
                                                <td class="text-right">
                                            ...
                                            <tr>
                                                <td>
                                                    <p class="m-0 d-inline-block align-middle">
                                                        <a href="#!" class="text-body font-weight-bold">Tanggal
                                                            Kedatangan</a>
                                                        <br>
                                                </td>
                                                <td class="text-right">
                                                    {{ \Carbon\Carbon::parse($transaction->check_in)->locale('id_ID')->isoFormat('dddd, D MMMM Y') }}
                                                </td>
                                            </tr>
                                            @if ($userRole === 'super_admin')
                                                <tr>
                                                    <td>
                                                        <p class="m-0 d-inline-block align-middle">
                                                            <a href="#!" class="text-body font-weight-bold">Pesan /
                                                                Catatan</a>
                                                            <br>
                                                    </td>
                                                    <td class="text-right">
                                            ...
                                            @endif
                                            {{-- @php
                                            $grand_total = $transaction->people_count * $transaction->days *
                                            $transaction->wisata->price;
                                            @endphp --}}
            ...
            @if ($transaction->status == 1)
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="form-v1" method="POST"
                                action="{{ route('dashboard.transaction.testimoni_update', $transaction->id) }}">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="mb-4">
                                            ...
                                            <div class="stars stars-example-fontawesome">
                                                <select id="demo-fontawesome" name="star_score" autocomplete="off">
                                                    <option value="1" {{ $transaction->star_score == '1' ? 'selected' : '' }}>
                                                        1</option>
                                                    <option value="2" {{ $transaction->star_score == '2' ? 'selected' : '' }}>
                                                        2</option>
                                                    <option value="3" {{ $transaction->star_score == '3' ? 'selected' : '' }}>
                                                        3</option>
                                                    <option value="4" {{ $transaction->star_score == '4' ? 'selected' : '' }}>
                                                        4</option>
                                                    <option value="5" {{ $transaction->star_score == '5' ? 'selected' : '' }}>
                                                        5</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-label-group">
                                            <textarea name="testimoni" id="testimoni" cols="30" rows="10"
                                                class="form-control"
                                                placeholder="Berikan Review Anda">{{ $transaction->testimoni }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-12 text-right">
                                        <button class="btn btn-primary"
                                            type="submit">{{ $transaction->testimoni != '' ? 'Perbarui Review Anda' : 'Kirim Review'}}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
