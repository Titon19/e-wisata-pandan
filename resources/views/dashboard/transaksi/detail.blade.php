                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="stars stars-example-fontawesome">
                                            <select id="demo-fontawesome" name="star_score" autocomplete="off" readonly
                                                disabled>
                                                <option value="1" {{ $transaction->star_score == '1' ? 'selected' : '' }}>1
                                                </option>
                                                <option value="2" {{ $transaction->star_score == '2' ? 'selected' : '' }}>2
                                                </option>
                                                <option value="3" {{ $transaction->star_score == '3' ? 'selected' : '' }}>3
                                                </option>
                                                <option value="4" {{ $transaction->star_score == '4' ? 'selected' : '' }}>4
                                                </option>
                                                <option value="5" {{ $transaction->star_score == '5' ? 'selected' : '' }}>5
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-label-group">
                                        <textarea name="testimoni" id="testimoni" cols="30" rows="10" class="form-control"
                                            placeholder="Berikan Review Anda" readonly
