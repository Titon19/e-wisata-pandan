...
class WisataController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return Redirect::route('dashboard.wisata.index')->with('success', 'Berhasil menambahkan data');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return Redirect::route('dashboard.wisata.index')->with('success', 'Berhasil mengubah data');
    }
