<ul class="pc-navbar">
    ...
    <li class="pc-item"><a href="{{ route('dashboard.fasilitas_wisata.index') }}" class="pc-link "><span
                class="pc-micon"><i data-feather="layers"></i></span><span class="pc-mtext">Fasilitas</span></a></li>
    ...
    <li class="pc-item"><a href="{{ route('dashboard.ticket.index') }}" class="pc-link "><span class="pc-micon"><i
                    data-feather="life-buoy"></i></span><span class="pc-mtext">Tiket</span></a></li>
    <li class="pc-item"><a href="{{ route('dashboard.ticket_in.index') }}" class="pc-link "><span class="pc-micon"><i
                    data-feather="life-buoy"></i></span><span class="pc-mtext">Restock Tiket</span></a></li>

    <li class="pc-item pc-caption">
        <label>Transaksi</label>
    </li>
    <li class="pc-item"><a href="{{ route('dashboard.payment_method.index') }}" class="pc-link "><span
                class="pc-micon"><i data-feather="shopping-cart"></i></span><span class="pc-mtext">Metode
    ...
    <li class="pc-item"><a href="{{ route('dashboard.testimoni.index') }}" class="pc-link "><span class="pc-micon"><i
