                    ...
                    <div class="card-body">
                        <center>
                            <div class="row mb-2">
                                <div class="col-md-6">
                                    <label>Dari</label>
                                    <input type="date" class="form-control" name="date_from" id="date_from_chart_5"
                                        max="{{ now()->subDays(1)->isoFormat('YYYY-MM-DD') }}" />
                                </div>
                                <div class="col-md-6">
                                    <label>Sampai</label>
                                    <input type="date" class="form-control" name="date_to" id="date_to_chart_5"
                                        value="{{ now()->isoFormat('YYYY-MM-DD') }}"
