...
<head>
  ...
  <![endif]-->
    ...
    <style>
        .invalid-feedback {
            display: block;
            /* pastikan elemen feedback ditampilkan */
            color: red;
            /* sesuaikan warna sesuai desain */
            margin-top: 5px;
            /* atur jarak dari elemen input jika diperlukan */
        }
    </style>
...
<div class="auth-wrapper align-items-stretch aut-bg-img">
    <div class="flex-grow-1 d-flex">
        <div class="h-100 d-md-flex align-items-end auth-side-img"
            style="background-image: url('{{ asset('img/selider19.jpg') }}')">
            <div class="col-sm-10 auth-content w-auto">
                {{-- <img src="{{ asset('/') }}img/e-wisata.png" alt="{{ config('app.name') }}" class="img-fluid"
                    style="max-width: 400px;"> --}}
                {{-- <h1 class="text-white my-4">Login</h1>
        ...
        <form method="POST" action="{{ route('login') }}" class="auth-side-form">
            ...
            <div class="auth-content">
                ...
                <h6 class="mb-4 f-w-400">Silahkan Masukan Username dan Password anda dengan Benar!</h6>
                <!-- @if(session('error'))
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text"
                        class="form-control @error('username') is-invalid @enderror {{ session('error') ? 'is-invalid' : '' }}"
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="password"
                        class="form-control @error('password') is-invalid @enderror {{ session('error') ? 'is-invalid' : '' }}"
                ...
                <div class="text-center">
                    ...
                    <p class="mb-0 text-muted">Belum punya akun? <a href="{{ url('register') }}" class="f-w-400">Daftar
                            Sekarang!</a></p>
                </div>
            </div>
        </form>
