...
@section('content')
<div class="bradcam_area" style="background-image: url('{{ asset('img/selider14.jpg') }}')">
    <div class="container">
        <div class="row">
            <div class="col-xl-12">
                <div class="text-center">
                    <h3 style="color: white; font-weight: bold; font-size: 50px;">PROMO WISATA PANTAI PANDAN</h3>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    <div class="section_title text-center mb_70">
                        <h3><b>PROMO TERBARU <br> WISATA PANTAI PANDAN</b></h3>
                        <p>Nikmati juga Promo-Promo Menarik dari Wisata Pantai Pandan
                        <hr>
                    </div>
                </div>
            </div>
